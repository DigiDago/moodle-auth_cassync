 ...
 */
function auth_cassync_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = []) {
    ...
    $itemid = 0;
    $fs = get_file_storage();
    $file = $fs->get_file($context->id, 'auth_cassync', $filearea, $itemid, $filepath, $filename);
    if (!$file) {
